class EventController < ApplicationController
	...
	def save_message
      ...
      commit["content"] = Iconv.conv('utf-8','gbk',commit["content"])
	...
	def join
        if id = params[:id] 
			  ...
			  @current_user.save
			  @activity = Activity.find(id)
			  mail = MailReminding.find(:first,:conditions =>["activity_id = ? and user_id =?",id, @current_user.id])  #����ʼ�������û�и���Ϣ�����
			  if mail
			  		mail.activity_id = id
